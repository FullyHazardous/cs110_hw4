'use strict'
    ...
    let todos =[
      {id:Math.random()+'',message:"Finish the CS homework",completed:false},
      {id:Math.random()+'',message:"Check the results",completed:false},
      {id:Math.random()+'',message:"Be Happy!",completed:false}
    ];
